    ...
    <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
      <div className="space-y-6">
        ...
        <h1 className="max-w-2xl text-5xl font-semibold leading-tight text-white transition duration-500 sm:text-6xl">
          I build responsive web experiences with a full-stack mindset.
        </h1>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
          <button
            type="button"
            onClick={onLearnMore}
            className="inline-flex w-full items-center justify-center rounded-full bg-violet-500 px-6 py-3 text-sm font-semibold text-white transition duration-300 hover:-translate-y-0.5 hover:bg-violet-400 sm:w-auto"
            data-cursor-target
          >
      ...
      <div className="relative mx-auto flex max-w-[420px] justify-center">
        <div className="relative overflow-hidden rounded-full border border-white/10 bg-[#130b26]/70 p-1 transition duration-500 hover:-translate-y-1 hover:shadow-[0_40px_120px_rgba(139,92,246,0.22)]">
          ...
          <img
            src={heroImg}
            alt="Profile"
            className="relative h-72 w-72 rounded-full object-cover transition duration-500 hover:scale-[1.02]"
          />
        </div>
      </div>
    </div>
